...
class _DashboardTabState extends State<DashboardTab> with WidgetsBindingObserver {
  ...
  void _refreshData() {
    ...
    reportProvider.fetchAllReports().then((_) {
      ...
      if (authProvider.isAuthenticated) {
        print('🔄 Refreshing user reports for dashboard stats');
        reportProvider.fetchUserReports().then((_) {
          print('📊 User reports count: ${reportProvider.userReports.length}');
          ...
          Container(
            ...
            child: Consumer<ReportProvider>(
              builder: (context, reportProvider, child) {
                ...
                print('📊 Dashboard Stats - Total: $totalIssues, Pending: $pendingCount, InProgress: $inProgressCount, Resolved: $resolvedCount');
